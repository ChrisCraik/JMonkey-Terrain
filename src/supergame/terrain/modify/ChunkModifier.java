...
public abstract class ChunkModifier implements ChunkModifierInterface {
    ...
    private ArrayList<Chunk> mChunks = null;
    ...
    public static void update(ChunkProcessor cp) {
        ...
        if (!sServerMode) {
            ...
            ArrayList<Chunk> swapList = new ArrayList<Chunk>();
            for (ChunkMessage message : swapArray) {
                swapList.add(new Chunk(message));
            }
            cp.swapChunks(swapList);
        }
    }
    ...
    final public void tryStart(ChunkProcessor cp) {
        ...
        ArrayList<ChunkIndex> indexList = getIndexList();
        mChunks = new ArrayList<Chunk>(indexList.size());
     ...
     */
    protected abstract ArrayList<ChunkIndex> getIndexList();
     ...
     */
    protected static ArrayList<ChunkIndex> getBoundingIndexList(float xPos,
            float yPos, float zPos, float xSize, float ySize, float zSize) {
        ArrayList<ChunkIndex> list = new ArrayList<ChunkIndex>();
